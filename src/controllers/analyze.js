...
async function getAnalyze(req, res, next){
    try{
        ...
        // get data
        const analyze = await knex('Food Nutrition Fact').where("FoodNameENG", "Fried Rice").select('FoodID', 'FoodNameENG', 'FoodNameTH', 'Calories', 'Fat', 'Carb', 'Protein', 'Sodium', 'Portion', )
